...
if(!empty($_POST['come']) or (!empty($_POST['out']))){
    ...
    if(!empty($_POST['come'])){
        ...
        //ツイート
        $res = $connection->post("statuses/update", array("status" => $twittertime.$_SESSION['userName'].'さんが登校しました. #卒研支援'));
        ...
        //ツイート
        $res = $connection->post("statuses/update", array("status" => $twittertime.$_SESSION['userName'].'さんが下校しました. #卒研支援'));
...
if(!empty($_POST['outreset'])){//下校取り消し
    ...
    //ツイート
        $res = $connection->post("statuses/update", array("status" => $twittertime.$_SESSION['userName'].'さんの下校が取り消されました. #卒研支援'));
